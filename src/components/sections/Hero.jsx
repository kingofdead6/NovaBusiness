    ...
    >
      ...
      */}
      <Engraving
        ...
        warp="fort"
        alt=""
        className="hero-plate-gauche pointer-events-none absolute opacity-[0.30] sm:opacity-[0.18] lg:opacity-[0.14]"
      />
      <Engraving
        src={cosmographia}
        ratio="1/1"
        ...
        warp="normal"
        alt=""
        className="hero-plate-droite pointer-events-none absolute opacity-[0.26] sm:opacity-[0.18]"
      />
